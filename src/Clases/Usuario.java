...
public class Usuario implements Comparable<Usuario> {
    ...
    // Arranca en 100 para que los IDs queden lindos (101, 102, 103...)
    ...
    // ── Constructor CON id manual (para cargarDatosPrueba) ───────────────────
    public Usuario(int id, String nombre, String email, TipoCuenta tipoCuenta) {
        ...
        // Si el id manual es mayor al contador, actualizamos el contador
